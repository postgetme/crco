...
/*$PAGE*/
    *err = OS_ERR_NONE;                                    /* Assume NO error until proven otherwise.  */
    OS_ENTER_CRITICAL();
    switch (wait_type) {
...
/*$PAGE*/
    ...
    OS_EXIT_CRITICAL();
    *err = OS_ERR_NONE;                                    /* Event(s) must have occurred              */
    return (flags_rdy);
}
/*$PAGE*/
/*
