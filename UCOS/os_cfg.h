...
*
* File    : OS_CFG.H
* By      : Jean J. Labrosse   #if (OS_EVENT_NAME_SIZE > 1) || (OS_FLAG_NAME_SIZE > 1) || (OS_MEM_NAME_SIZE > 1) || (OS_TASK_NAME_SIZE > 1)
* Version : V2.84
*
* LICENSING TERMS:
* ---------------
...
#define OS_CFG_H
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    600    /* Timer      task stack size (# of OS_STK wide entries)        */
...
#define OS_APP_HOOKS_EN           1    /* When 1, application-defined hooks are called from os_cpu_c.c */
...
#define OS_TMR_CFG_NAME_SIZE      6    /*     Determine the size of a timer name                       */
#define OS_TMR_CFG_WHEEL_SIZE     6    /*     Size of timer wheel (#Spokes)                            */
